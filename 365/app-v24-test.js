...
const STORY_API_URL = 'https://questions-365-stories-test.iensunny-365.workers.dev';
const BOT_LINK = 'https://t.me/qqwestionsBot';
const APP_VERSION = 'v24-test';
...
async function storyApi(path, data = {}) {
...
async function shareCard(text, label, filename, includeNumber = false, destination = 'chat') {
  ...
  if (destination === 'story') {
    ...
    try {
      ...
      const uploaded = await storyApi('/story-card', { image });
